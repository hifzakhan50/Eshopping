            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            @isset(auth()->user()->customerProfile->name)
                            <div class="user-nav d-sm-flex d-none"><span
                                    class="user-name text-bold-600">{{ auth()->user()->customerProfile->name}}</span><span
                                    class="user-status">Available</span></div>
                            @endisset
                            @isset(auth()->user()->customerProfile->image)
                            <span><img class="round" src="{{ getImageSrc(auth()->user()->customerProfile->image)}}"
