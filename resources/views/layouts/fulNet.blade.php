...
<head>
    ...
    <title>Fullfillment Network  - Mega Shoppy</title>
...
{{--                    </li>--}}
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><span class="badge badge-pill badge-primary badge-up"></span></a>
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a href="#"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">
                        Manage Requests</span>
                    <span class="badge badge badge-warning badge-pill float-right mr-2"></span></a>
                <ul class="menu-content">

                        <ul class="menu-content">
                            <li class=""><a href="{{url('fulNet/requestManagement/create')}}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="Analytics">Create Request</span></a>
                            </li>

                            <li class=""><a href="{{ url('fulNet/requestManagement/all') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item"
                                        data-i18n="Analytics">All Requests</span></a>
                            </li>
...
<!--
                    <li class=" nav-item"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Products</span>
                        ...
                        <ul class="menu-content">
                            <li class="active"><a href="{{url('seller/products/create')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Analytics">Add products</span></a>
                            </li>
                        </ul>
                </ul>
            </li> -->
