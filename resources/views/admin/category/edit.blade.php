        ...
        <div class="card-body">
            <form method="POST" action="{{ route('category.update',$cat->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="images-upload" type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ $cat->image}}" required autocomplete="image" autofocus>
                    ...
                    <div class="images-preview col-md-6 offset-4">
                        <img src="{{ getImageSrc($cat->image) }}" class="w-25">
                    </div>
                </div>
